...
public class A_Lihat_Data_Petugas extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(A_Lihat_Data_Petugas.class.getName());

    /**
     * Creates new form Login
     */
    public A_Lihat_Data_Petugas() {
        initComponents();
        loadTable();
    }
private void loadTable() {
    PetugasDAO dao = new PetugasDAO();
    javax.swing.table.DefaultTableModel model = dao.getPetugasTableModel();
    jTable1.setModel(model);
    jTable1.setDefaultEditor(Object.class, null); // buat tabel tidak bisa di-edit
}
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon("C:\\Users\\Ahmad samuel\\Documents\\PA_SISA_OOP fiks\\PA_SISA_OOP\\src\\main\\java\\icon\\lihat data petugas.jpg")); // NOI18N
...
public static void main(String[] args) {
    java.awt.EventQueue.invokeLater(() -> {
        new A_Lihat_Data_Petugas().setVisible(true);
    });
}
}
